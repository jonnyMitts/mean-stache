...
angular.module('bbContestApp')
  ...
  .controller('ScheduleCtrl', function ($scope) {
    ...
    // $scope.offices = [
    //   {name:"Dr. Nose1", practice:"Atlanta ENT", type:"ENT", address:"123 Main Street", city:"Atlanta", state:"GA", officeId:1},
    //   {name:"Dr. Nose2", practice:"Atlanta ENT", type:"ENT", address:"123 Main Street", city:"Atlanta", state:"GA", officeId:2},
    //   {name:"Dr. Nose3", practice:"Atlanta ENT", type:"ENT", address:"123 Main Street", city:"Atlanta", state:"GA", officeId:3},
    //   {name:"Dr. Nose4", practice:"Atlanta ENT", type:"ENT", address:"123 Main Street", city:"Atlanta", state:"GA", officeId:4},
    // ];
    // $scope.offices = function(){
    // 	var offices = [];
